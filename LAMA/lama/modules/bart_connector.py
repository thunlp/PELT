...
class Bart(Base_Connector):
    def __init__(self, args):
        ...
        self.luke_tokenizer = BartTokenizer.from_pretrained( '/home/yedeming/bert_models/bart-base' )
        self.luke_model = BartForConditionalGeneration.from_pretrained(args.luke_model_dir)
