...
from .modeling_robertaent import EntityEmbeddings
from .modeling_bert import BertEmbeddings, BertLayerNorm, BertModel, BertPreTrainedModel, gelu, BertPooler, BertLayer, BertEncoder, BertPredictionHeadTransform

logger = logging.getLogger(__name__)


class BertEntModel(BertPreTrainedModel):
    """
